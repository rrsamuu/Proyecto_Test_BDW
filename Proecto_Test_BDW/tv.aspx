<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tv.aspx.cs" Inherits="Proecto_Test_BDW.tv" %>
<!DOCTYPE html>
<html lang="en">
<head runat="server">
    <meta charset="utf-8">
...
<form id="form1" runat="server">
  ...
  <div class="progress">
    <div class="progress-bar">50% Complete</div>
      ...
      <center>
       <asp:Button ID="btn_cv" runat="server" Text="SIGUENTES" OnClick="btn_cv_Click" CssClass="btn log-in"/>
          </center>
  </div>
</form>
</div>
