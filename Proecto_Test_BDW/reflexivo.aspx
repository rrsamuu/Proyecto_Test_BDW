<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reflexivo.aspx.cs" Inherits="Proecto_Test_BDW.reflexivo" %>
...
<form id="form1" runat="server">
   <div class="con">
    ...
    <div class="progress-bar">100% Complete</div>
      ...
      <h2>Tu perfil es:  <br />REFLEXIVO</h2>
...
-          Cuando tienen que actuar sin poder planificar previamente.</th>
       ...
       <center>
       <asp:Button ID="btn_intentar5" runat="server" Text="Volver a Intentarlo"  CssClass="btn log-in" OnClick="btn_intentar5_Click"/>
          </center>
   </header>
   <br/>
  </div>
