<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cv.aspx.cs" Inherits="Proecto_Test_BDW.cv" %>
<!DOCTYPE html>
<html lang="en">
<head runat="server">
    <meta charset="utf-8">
...
<form id="form1" runat="server">
   ...
   <header class="head-form">
      <h2>Cuarta Parte</h2>
       <br />
  <div class="progress">
    <div class="progress-bar">75% Complete</div>
  </div>
      ...
      <center>
       <asp:Button ID="btn_eleger_perfil" runat="server" Text="VER RESULTADO" OnClick="btn_eleger_perfil_Click" CssClass=" btn log-in"/>  
          </center>
  </div>
</form>
</div>
