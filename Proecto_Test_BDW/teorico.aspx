<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="teorico.aspx.cs" Inherits="Proecto_Test_BDW.teorico" %>
...
-          Cuando tienen que actuar sin un fundamento teórico.</th>
       ...
       <center>
       <asp:Button ID="btn_intentar3" runat="server" Text="Volver a Intentarlo"  CssClass="btn log-in" OnClick="btn_intentar3_Click"/>
          </center>
   </header>
   <br/>
  </div>
